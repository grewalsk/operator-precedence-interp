...
\caption{Multiplication accuracy by wrapper. The blind spot is position-dependent
(left-placed $(\,0{+}B\,)$ vs right-placed $(\,B{+}0\,)$) and not uniformly worse under
instruction tuning (plain parentheses).}
\label{fig:wrapper}
\end{figure}
