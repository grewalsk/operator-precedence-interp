...
nesting degrades \emph{addition} too (instruct nested addition falls to $0.25$ from $0.99$), so
we treat depth as a general parsing stressor, not more composition evidence. \emph{Magnitude} is ruled out: within
